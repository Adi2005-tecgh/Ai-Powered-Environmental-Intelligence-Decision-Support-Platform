...
import { Shield, RefreshCw, AlertCircle, TrendingUp, Activity, MapPin, DollarSign } from 'lucide-react';
            ...
            <div className="mt-8 space-y-8">
                ...
                {activeTab === 'risk' && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
                        ...
                        <SectionHeader title="AI Risk Insights & Alerts" description="Isolation Forest Anomalies & LSTM Trend Explainability" />
                        <AIRiskInsights city={selectedCity} />
                    </div>
                )}
